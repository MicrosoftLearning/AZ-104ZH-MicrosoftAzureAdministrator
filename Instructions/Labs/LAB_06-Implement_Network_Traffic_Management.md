...
1. 添加一个对等互连，设置如下（其他设置则保留默认值）：
    ...
    | 允许从 az104-06-vnet2 到 az104-06-vnet01 的转发流量 | **已启用** |
...
1. 添加一个对等互连，设置如下（其他设置则保留默认值）：
    ...
    | 允许从 az104-06-vnet3 转发流量到 az104-06-vnet01 | **已启用** |
...
1. 单击 **“网络接口”** 标签旁边的 **“az104-06-nic0”** 链接 ，然后在 **“az104-06-nic0”** 网络接口边栏选项卡中的 **“设置”** 部分，在 **“设置”** 部分，单击 **“IP 配置”**。 
...
1. 点击 **“检查”** ，然后等待至返回连接性检查结果。验证状态是否为 **“可访问”**。查看网络路径，并注意流量是通过 **“10.60.0.4”** 路由，分配到 **“az104-06-nic0”** 网络适配器。
...
1. 在 **az104-06-vnet01** “虚拟网络”边栏选项卡的 **“设置”** 部分，单击 **“子网”**，然后单击 **“+ 添加”**。
...
1. 单击 **“下一步： 前端 >”**，并在 **“创建一个应用程序网关”** 边栏选项卡的 **“前端”** 选项卡上，指定以下设置（保留其他设置的默认值）：
    ...
    | --- | --- |
    | 前端 IP 地址类型 | **公共** |
    | 公共 IP 地址| 新公共 IP 地址 **az104-06-pip5** 的名称 |

1. 单击 **“下一步： 后端 >”**，在 **“创建应用程序网关”** 边栏选项卡的 **“后端”** 选项卡上，单击 **“+ 添加后端池”**，以及在 **“添加后端池”** 边栏选项卡上，指定以下设置（保留其他设置的默认值）：
...
1. 单击 **“添加”**，单击 **“下一个： 配置 >”**，并且在 **“创建应用程序网关”** 边栏选项卡的 **“配置”** 选项卡上，单击 **“+ 添加规则”**。 
...
1. 在 **“添加一个路由规则”** 边栏选项卡的 **“后端目标”** 选项卡上，单击 **“HTTP 设置”** 文本框旁边的 **“新建”**，并在 **“添加一个 HTTP 设置”** 边栏选项卡上，指定以下设置（保留其他设置的默认值）：
