...
1. 从 **“az104-02-mg1”** 边栏选项卡，单击 **“+ 添加订阅”**，并将你要在本实验室中使用的订阅添加到管理组。
    ...
    >**备注**： 将 Azure 订阅的 ID 复制到剪贴板。在下一个任务中需要使用它。
...
1. 在 Azure 门户中，启动 **Cloud Shel** 中的 **“PowerShell”** 会话。
...
1. 右键单击代表你的 Azure 订阅的条目右侧的**省略**号图标，然后单击 **“移动”**。

1. 在 **“移动”** 边栏选项卡中，选择订阅最初所属的管理组，然后单击 **“保存”**。 

  >**备注**：这是**租户根管理组**，除非你在运行此实验室之前创建了自定义管理组层次结构。

1. 导航回 **“管理组”** 边栏选项卡，右键单击 **“az104-02-mg1”** 管理组右侧的**省略**号图标，然后单击 **“删除”**。
