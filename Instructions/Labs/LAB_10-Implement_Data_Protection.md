...
你的任务是对使用 Azure 恢复服务来备份和还原 Azure 虚拟机和本地计算机上托管的文件这一过程进行评估。此外，你还想确定保护恢复服务保管库中所存数据的方法，以防意外数据丢失或恶意数据丢失。
...
1. 在“Cloud Shell”窗格的工具栏中，选择 **“上传/下载文件”** 图标，在下拉菜单中选择 **“上传”**，然后将文件 **\\Allfiles\\Labs\\10\\az104-10-vms-template.json** 和 **\\Allfiles\\Labs\\10\\az104-10-vms-parameters.json** 上传到 Cloud Shell 主目录中。
...
1. 最小化 Cloud Shell（但不要将其关闭）。
    ...
    >**注意**：不要等待部署完成，而是继续执行下一个任务。本部署会花上5分钟左右。
...
1. 在 **“安全设置”** 边栏选项卡上，请注意，**“软删除（对于 Azure 虚拟机）”** 为 **“已启用”**。
...
1. 在 **az104-10-vm1** Azure VM 的远程桌面会话中，请在 **“服务器管理器”** 窗口中，单击 **“本地服务器”**，然后单击 **“IE 增强的安全配置”**，并为管理员 **“关闭”** 此配置。

1. 在接入 **az104-10-vm1** Azure 虚拟机的远程桌面会话中，启动 Internet Explorer，浏览到 [Azure 门户](https://portal.azure.com)，然后使用凭据登录。 
...
1. 切换到显示 Azure 门户的 Internet Explorer 窗口，在 **“准备基础结构”** 边栏选项卡上，选中 **“已下载或使用最新的恢复服务器代理”** 复选框，然后单击 **“下载”**。
...
1. 切换到显示 Azure 门户的“Internet Explorer”窗口，导航回“恢复服务保管库”边栏选项卡，然后单击 **“备份项目”**。 
...
1. 切换到 Microsoft Azure 备份窗口并单击 **“恢复数据”**。 这将启动 **“恢复数据向导”**。

1. 在**恢复数据向导** 的 **“入门”** 页面上，确保选中 **“此服务器(az104-10-vm1.)”** 选项并单击 **“下一步”**。
...
1. 在 **“az104-10-vm0”** 边栏选项卡上，单击 **“连接”**，然后在下拉菜单中，单击 **“RDP”**，再在 **“与 RDP 连接”** 边栏选项卡上，单击 **“下载 RDP 文件”** 并按照提示启动远程桌面会话。
...
1. 在 **az104-10-vm0** Azure 虚拟机的远程桌面会话中，启动 Internet Explorer，浏览到 [Azure 门户](https://portal.azure.com)，然后使用凭据登录。 
...
1. 启动“文件资源管理器”，导航到 **“下载”** 文件夹，右键单击新下载的文件，选择右键菜单中的 **“属性”**，再在 **“属性”** 对话框中，选中 **“解除锁定”** 复选框，然后单击 **“确定”**。
...
1. 当提示从门户提供密码时，请从 **“文件恢复”** 边栏选项卡上的 **“用于运行脚本的密码”** 文本框中复制密码，并将其粘贴在命令提示符下，然后按 **Enter**。
    ...
    >***注意**：如果此时收到错误消息，请刷新 Internet Explorer 窗口并重复最后三个步骤。

1. 等待装载过程完成，查看 Windows PowerShell 窗口中的信息性消息，记下分配给承载 **“Windows”** 卷的驱动器号，然后启动“文件资源管理器”。
...
1. 启用 **“与此服务器相关的 1 个备份项目已有备份数据。我知道单击‘确认’会永久删除所有云备份数据。此操作无法撤消。此订阅的管理员可能会收到数据删除的警告”** 标签旁边的复选框，然后单击 **“删除”**。
...
1. 导航回 **az104-10-rsv1** “恢复服务保管库”边栏选项卡，在 **“设置”** 部分，单击 **“属性”**。

1. 在 **“az104-10-rsv1 - 属性”** 边栏选项卡上，在 **“安全设置”** 标签下单击 **“更新”** 链接。 

1. 在 **“安全设置”** 边栏选项卡上，禁用 **“软删除（对于 Azure 虚拟机）”** 并单击 **“保存”**。
...
1. 等待取消删除操作完成，刷新浏览器页面（如有需要），导航回 **“az104-10-vm0”** 备份项目边栏选项卡，然后单击 **“删除备份数据”**。
