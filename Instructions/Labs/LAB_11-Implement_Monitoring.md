...
1. 在 **“创建警报规则”** 边栏选项卡的 **“条件”** 部分中，单击现有条件。 
...
1. 在 **“添加操作组”** 边栏选项卡上，指定以下设置（将其他设置保留为默认值）：
...
1. 在 **“添加操作组”** 边栏选项卡的 **“操作”** 部分中，指定以下设置（将其他设置保留默认值）：
...
1. 在 **“az104-11-ag1 电子邮件”** 操作行中，单击 **“编辑详细信息”**

1. 在 **“电子邮件/短信/推送/语音”** 边栏选项卡上选择 **“电子邮件”** 复选框，在 **“电子邮件”** 文本框中键入电子邮件地址，其他设置保留默认值，单击 **“确定”**，然后回到 **“添加操作组”** 边栏选项卡，再次单击 **“确定”**。

1. 回到 **“创建规则”** 边栏选项卡，指定以下设置（将其他设置保留默认值）：
...
1. 在命令提示符下运行以下命令，将 **hosts** 文件还原到原始位置：
...
1. 在 **“选择范围”** 边栏选项卡上，导航至 **az104-11-rg0** 资源组，将其展开，选择 **“a104-11-vm0”**，然后单击 **“应用”**。

1. 在查询窗口中，粘贴以下查询并单击 **“运行”**：
...
1. 单击工具栏中的 **“示例查询”**，查看 **“开始使用示例查询”** 窗格中的每个选项卡，找到 **“跟踪 VM 可用性”**，然后单击 **“运行”**。

1. 查看生成的图表，并删除包含以下文本的行：

   ```
   | 其中 TimeGenerated > ago(1h)
   ```

    >**注意**：结果，工具栏中的 **“时间范围”** 条目从 **“在查询中设置”** 变更为 **“最近 24 小时”**。 

1. 重新运行查询并检查生成的图表。

1. 在 **“新查询 1”** 选项卡上，查看 **“表”** 选项卡上的 **“虚拟机”** 表列表。
...
1. 在工具栏中单击 **“示例查询”**，在 **“开始使用示例查询”** 窗格中，查看每个选项卡，找到 **“虚拟机可用磁盘空间”**，然后单击 **“运行”**。
